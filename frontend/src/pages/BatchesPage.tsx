                    ...
                    columns={[
                        ...
                        },
                        {
                            key: 'current_semester', label: 'Semester', sortable: true, render: row => {
                                const sem = row.current_semester ?? (row as unknown as Record<string, unknown>).currentSemester;
                                return (
                    ...
                    columns={[
                        ...
                        },
                        {
                            key: 'semester', label: 'Semester', render: row => {
                                const batch = batchMap[row.batch_id as number];
                                const sem = batch?.current_semester ?? (batch as unknown as Record<string, unknown>)?.currentSemester;
